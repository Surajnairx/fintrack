...
function Dashboard() {
  ...
  return (
    <div className="space-y-6 w-full">
      ...
      <div className="justify-center lg:grid-cols-3 gap-4 lg:gap-6">
        <div
          ref={(el) => (chartsRef.current[0] = el)}
          className="lg:col-span-2 p-4 sm:p-5 rounded-xl border flex flex-col"
        >
          <div className="flex flex-col sm:flex-row justify-between items-center sm:items-center mb-4 gap-2 sm:gap-0">
            <h2 className="text-lg">Balance Overview</h2>
            <div className="flex gap-2 flex-wrap">
              {["Week", "Month", "Year"].map((t, idx) => (
                <button
                  ...
                  className={`px-3 py-1 rounded text-sm border ${timeline === t ? "bg-blue-600 text-white" : " text-gray-500"}`}
                >
                  {t}
                </button>
              ))}
      ...
      <div className=" p-4 sm:p-5 rounded-xl border overflow-x-auto">
